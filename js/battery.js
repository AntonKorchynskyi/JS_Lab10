...
function updateBatteryStatus(battery) {
    ...
    chargeLevelNum = battery.level * 100;

    chargeLevel.textContent = chargeLevelNum + "%";
    chargeMeter.value = chargeLevelNum;

    img.setAttribute("src", `https://robohash.org/${chargeLevelNum}percent.png`);
}
